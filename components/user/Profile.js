...
import { updateProfileUser } from '../../store/actions/userAction'
import { UPDATE_PROFILE_RESET } from '../../store/actioTypes/userTypes'
const Profile = () => {
    ...
    const { loading: updateLoading, error, isUpdated } = useSelector(state => state.user)
    ...
    }, [dispatch, loadedUser, error, isUpdated])
